...
export function TransactionTable({ transactions, onUpdateTransaction, onRemoveTransaction, title = "Transações" }: TransactionTableProps) {
    ...
    return (
        <div className="w-full overflow-hidden rounded-xl border border-neutral-800 bg-neutral-900/30 backdrop-blur-sm transition-all duration-300">
            {/* Header with Collapse Toggle */}
            <div
                onClick={() => setIsCollapsed(!isCollapsed)}
                className="flex items-center justify-between p-4 bg-neutral-900/80 border-b border-neutral-800 cursor-pointer hover:bg-neutral-800/80 transition-colors group"
            >
